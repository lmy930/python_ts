...
BASE_PATH = '/home/mengyao.li/Code/ts_nr_simulation/test_and_sim/ulsim/20M_AWGN_case_0327/'
FILE_NAME = 'sfn0_slot8_ul_result.mat'
OUTPUT_FILE = 'C:/Users/tools/Desktop/20M_0327.xlsx'
...
def get_target_server(case_idx):
    ...
    if 8 <= case_idx <= 17:  return '177'
    if 18 <= case_idx <= 27: return '175'
    return None
